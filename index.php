            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="view/pengajar.php">Staff Pengajar</a></li>
                        <li><a class="dropdown-item" href="view/administrasi.php">Staff Administrasi</a></li>
                        <li><a class="dropdown-item" href="view/teknisi.php">Staff Teknisi</a></li>
                    </ul>
                </li>
            </ul>
